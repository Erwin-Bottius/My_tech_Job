        ...
        <Card className={classes.about__card}>
          <CardContent className={classes.about__card__content}>
            ...
            <Typography variant="body1" className={classes.about__card__content__description}>
              Mytechjob est un site d’annonces d’offres d’emplois que
            ...
            <Typography variant="body1" className={classes.about__card__content__description}>
              ...
              j'ai cependant fait le choix d'en faire un site pour rechercher
              un emploi dans le monde
    ...
    <div className={classes.aboutDesktop}>
      <Card className={classes.aboutDesktop__card}>
        <CardContent className={classes.aboutDesktop__card__content}>
          <Typography variant="h3" className={classes.aboutDesktop__card__content__title}>
            A Propos
          </Typography>
          <Typography variant="body1" className={classes.aboutDesktop__card__content__description}>
